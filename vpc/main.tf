...
resource "aws_subnet" "public_subnet_az1" {
  ...
  tags = {
    Name = "${var.environment}-public-sub-az1"
  }
}
...
resource "aws_subnet" "public_subnet_az2" {
  ...
  tags = {
    Name = "${var.environment}-public-sub-az2"
  }
}
...
resource "aws_subnet" "private_app_subnet_az1" {
  ...
  tags = {
    Name = "${var.environment}-private-app-sub-az1"
  }
}
...
resource "aws_subnet" "private_app_subnet_az2" {
  ...
  tags = {
    Name = "${var.environment}-private-app-sub-az2"
  }
}
...
resource "aws_subnet" "private_data_subnet_az1" {
  ...
  tags = {
    Name = "${var.environment}-private-data-sub-az1"
  }
}
...
resource "aws_subnet" "private_data_subnet_az2" {
  ...
  tags = {
    Name = "${var.environment}-private-data-sub-public_subnet_az2"
  }
}